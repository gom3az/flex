...
/// Control center: select a row, print `ACTION:`, let the wrapper act.
#[derive(Debug, Parser)]
...
fn run() -> anyhow::Result<()> {
    ...
    // ACTION: line and exits 0; the real center executor lands later.
    runner::run_select(Provider::Center, style)
}
