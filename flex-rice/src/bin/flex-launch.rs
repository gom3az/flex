...
/// Application launcher: select a row, print `ACTION:`, let the wrapper act.
#[derive(Debug, Parser)]
...
fn run() -> anyhow::Result<()> {
    ...
    // ACTION: line and exits 0; the real launch executor lands later.
    runner::run_select(Provider::Launch, style)
}
